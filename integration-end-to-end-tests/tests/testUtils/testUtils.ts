...
import type SelfTester from "sovendus-integration-tester/src/tester/integration-tester";
import type { ExplicitAnyType } from "sovendus-integration-tester/src/tester/integration-tester";
import { testLoadedIFrameId } from "sovendus-integration-tester/src/tester-ui/integration-test-overlay-css-vars";
...
function initializeWebDriver(browser: Browsers): {
  ...
  const extensionPath =
    browser === Browsers.Firefox
      ? resolve(
          __dirname,
          "../../../integration-tester/test_zips/firefox-test-sovendus-integration_TESTING.xpi",
        )
      : resolve(
          __dirname,
          "../../../integration-tester/test_zips/chrome-test-sovendus-integration_TESTING.crx",
        );
