...
import { TestingState, PageType, OverlaySize } from "../types";
...
import { ExtensionSettings } from "src/integration-tester-loader/browserExtensionLoader";
...
export const useOverlayState = (
  ...
  create<OverlayState>((set, get) => ({
    ...
    resizeOverlay: (direction: "increase" | "decrease") => {
      ...
      const newSizeIndex =
        direction === "increase" ? currentSizeIndex + 1 : currentSizeIndex - 1;
